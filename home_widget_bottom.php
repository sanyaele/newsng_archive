...
if ( $query->have_posts() ) {
	while ( $query->have_posts() ) {
		...
		<div style="padding-left:7px;padding-right:7px;">		
                <h5><a href="<?php the_permalink() ?>"><?php the_title(); ?></a> - <span style="color:#F00; font-size: small;"><strong>Buzz:</strong> <?php echo get_post_meta($query->post->ID, 'Buzz', true);?></span></h5>
        </div>
	<?php
    }
	...
	if ( $query2->have_posts() ) {
		while ( $query2->have_posts() ) {
			...
			<div style="padding-left:7px;padding-right:7px;">		
					<h5><a href="<?php the_permalink() ?>"><?php the_title(); ?></a> - <span style="color:#C00; font-size: small;"><strong>Buzz:</strong> <?php echo get_post_meta($query2->post->ID, 'Buzz', true);?></span></h5>
