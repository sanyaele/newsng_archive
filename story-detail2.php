...
jQuery(document).ready(function(){
	jQuery('.newsframe span').click(function () {
		jQuery('#show').slideDown("slow");
		jQuery('.column-a').css({"display": "none"});
		jQuery('.column-b').css({"width": "94%"});
		//jQuery(this).find('img').fadeTo(500, 0.6);
	});
	
	jQuery('.newsframe a').click(function () {
		jQuery('#show').slideDown("slow");
		//jQuery(this).find('img').fadeTo(500, 0.6);
	});
});
    	...
    	<div id="main-content-inner">
            ...
            <div class="main-content-bottom clearfix">
                <div class="column-b">
                  ...
                  <div class="newsframe clearfix"> <span href="#">Read Full Story Below</span> <a href="send2email.php?story=<?php echo $story->id; ?>" target="show"><img src="assets/sendfriend.png" alt="Send this story to your friends" width="113" height="23" border="0" /></a><br>
                  <iframe name="show" id="show" title="Show Details" src="<?php echo $story->firstlink;?>" width="100%" frameborder="1" height="700px"></iframe> </div>
                  <div class="clearfix">
